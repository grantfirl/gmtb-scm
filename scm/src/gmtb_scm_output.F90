...
subroutine output_append(scm_state, physics)
  ...
  if (scm_state%model_ics .or. scm_state%lsm_ics) then
    ...
    CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=scm_state%stc(:,1,1),START=(/1,scm_state%itt_out /)))
    CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="T_soil_2",VARID=var_id))
    CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=scm_state%stc(:,2,1),START=(/1,scm_state%itt_out /)))
    CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="T_soil_3",VARID=var_id))
    CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=scm_state%stc(:,3,1),START=(/1,scm_state%itt_out /)))
    CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="T_soil_4",VARID=var_id))
    CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=scm_state%stc(:,4,1),START=(/1,scm_state%itt_out /)))
    CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="soil_moisture_1",VARID=var_id))
    CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=scm_state%smc(:,1,1),START=(/1,scm_state%itt_out /)))
    CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="soil_moisture_2",VARID=var_id))
    CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=scm_state%smc(:,2,1),START=(/1,scm_state%itt_out /)))
    CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="soil_moisture_3",VARID=var_id))
    CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=scm_state%smc(:,3,1),START=(/1,scm_state%itt_out /)))
    CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="soil_moisture_4",VARID=var_id))
    CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=scm_state%smc(:,4,1),START=(/1,scm_state%itt_out /)))
  end if
