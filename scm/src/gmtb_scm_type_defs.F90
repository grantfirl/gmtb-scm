...
!!
  ...
  type scm_state_type
    ...
    integer                           :: hail_index  !< index for hail water in the tracer array
    ...
    integer                           :: ccn_nc_index !< index for cloud condensation nuclei number concentration in the tracer array
    integer                           :: graupel_vol_index !< index for graupel particle volume in the tracer array
    integer                           :: hail_vol_index !< index for hail particle volume in the tracer array
...
!!
  ...
  subroutine scm_state_create(scm_state, n_columns, n_levels, n_soil, n_snow, n_time_levels, tracers)
    ...
    scm_state%hail_index                      = get_tracer_index(scm_state%tracer_names,"hail")
    ...
    scm_state%ccn_nc_index                    = get_tracer_index(scm_state%tracer_names,"ccn_nc")
    scm_state%graupel_vol_index               = get_tracer_index(scm_state%tracer_names,"graupel_vol")
    scm_state%hail_vol_index                  = get_tracer_index(scm_state%tracer_names,"hail_vol")
