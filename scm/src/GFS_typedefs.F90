...
!--- tracer handling
    ...
    integer              :: nthl            !< tracer index for graupel
...
!--- stochastic physics options
    ...
    Model%nthl             = get_tracer_index(Model%tracer_names, 'hail',       Model%me, Model%master, Model%debug)
...
!GW-sources
    ...
    !--- 3D diagnostics for Thompson MP / GFDL MP / NSSL
