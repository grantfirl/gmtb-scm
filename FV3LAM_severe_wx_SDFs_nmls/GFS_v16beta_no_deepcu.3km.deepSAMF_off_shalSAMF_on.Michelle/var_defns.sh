...
EXPT_SUBDIR="2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST"
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
CCPP_PHYS_SUITE="FV3_GFS_v16beta_no_deepcu"
#
#-----------------------------------------------------------------------
#
...
GRID_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/grid"

RUN_TASK_MAKE_OROG="TRUE"
OROG_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/orog"

RUN_TASK_MAKE_SFC_CLIMO="TRUE"
SFC_CLIMO_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/sfc_climo"
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
WFLOW_LAUNCH_SCRIPT_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/launch_FV3LAM_wflow.sh"
WFLOW_LAUNCH_LOG_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/log.launch_FV3LAM_wflow"
CRONTAB_LINE=""
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
SR_WX_APP_TOP_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods"
HOMErrfs="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow"
USHDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush"
SCRIPTSDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/scripts"
JOBSDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/jobs"
SORCDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/sorc"
SRC_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/src"
PARMDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/parm"
MODULES_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/modulefiles"
EXECDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/bin"
FIXrrfs="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/fix"
FIXam="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/fix_am"
FIXLAM="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/fix_lam"
FIXgsm="/scratch1/NCEPDEV/global/glopara/fix/fix_am"
COMROOT=""
COMOUT_BASEDIR=""
TEMPLATE_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates"
UFS_WTHR_MDL_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/src/ufs_weather_model"
UFS_UTILS_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/src/UFS_UTILS"
SFC_CLIMO_INPUT_DIR="/scratch1/NCEPDEV/da/George.Gayno/ufs_utils.git/climo_fields_netcdf"
TOPO_DIR="/scratch1/NCEPDEV/global/glopara/fix/fix_orog"
EMC_POST_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/src/EMC_post"

EXPTDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST"
LOGDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/log"
CYCLE_BASEDIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST"
GRID_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/grid"
OROG_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/orog"
SFC_CLIMO_DIR="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/sfc_climo"
...
#-----------------------------------------------------------------------
#
GLOBAL_VAR_DEFNS_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/var_defns.sh"
# Try this at some point instead of hard-coding it as above; it's a more
# flexible approach (if it works).
#GLOBAL_VAR_DEFNS_FP=/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/setup.sh

DATA_TABLE_TMPL_FN="data_table"
DIAG_TABLE_TMPL_FN="diag_table.FV3_GFS_v16beta_no_deepcu"
FIELD_TABLE_TMPL_FN="field_table.FV3_GFS_v16beta_no_deepcu"
MODEL_CONFIG_TMPL_FN="model_configure.FV3_GFS_v16beta_no_deepcu"
NEMS_CONFIG_TMPL_FN="nems.configure"

DATA_TABLE_TMPL_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates/data_table"
DIAG_TABLE_TMPL_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates/diag_table.FV3_GFS_v16beta_no_deepcu"
FIELD_TABLE_TMPL_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates/field_table.FV3_GFS_v16beta_no_deepcu"
FV3_NML_BASE_SUITE_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates/input.nml.FV3"
FV3_NML_YAML_CONFIG_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates/FV3.input.yml"
FV3_NML_BASE_ENS_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/input.nml.base_ens"
MODEL_CONFIG_TMPL_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates/model_configure.FV3_GFS_v16beta_no_deepcu"
NEMS_CONFIG_TMPL_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates/nems.configure"

CCPP_PHYS_SUITE_FN="suite_FV3_GFS_v16beta_no_deepcu.xml"
CCPP_PHYS_SUITE_IN_CCPP_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/src/ufs_weather_model/FV3/ccpp/suites/suite_FV3_GFS_v16beta_no_deepcu.xml"
CCPP_PHYS_SUITE_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/suite_FV3_GFS_v16beta_no_deepcu.xml"

DATA_TABLE_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/data_table"
FIELD_TABLE_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/field_table"
FV3_NML_FN="input.nml"   # This may not be necessary...
FV3_NML_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/input.nml"
NEMS_CONFIG_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/expt_dirs/2019061512_CONUS_3km_GFS_v16beta_noDeep_TEST/nems.configure"

FV3_EXEC_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/bin/NEMS.exe"

LOAD_MODULES_RUN_TASK_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/load_modules_run_task.sh"

WRTCMP_PARAMS_TMPL_FP="/scratch2/BMC/ufs-phys/Michelle.Harrold/ufs-srweather-app_gfsMods/regional_workflow/ush/templates/wrtcmp_lambert_conformal"
#
#-----------------------------------------------------------------------
#
